app.controller('ControladorConsumo', function ($scope, $http) {
    ...
    // Variables para las gráficas (Dk)
    let chartPastel = null;
    let chartBarras = null;

    // Inicializar controlador (Dk)
    $scope.init = function () {
        $scope.cargarDatos();
    };

    // Cargar datos del JSON (Dk)
    $scope.cargarDatos = function () {
        console.log('Intentando cargar datos...');
        //ProduccionEnergia (Dk)
    ...
    $scope.procesarDatos = function () {
        ...
        // Obtener años únicos y ordenar descendente (Dk)
    ...
    };    // Función principal para calcular consumo (Dk)
    $scope.calcularConsumo = function () {
        ...
        // Buscar datos del país y año seleccionados (Dk)
        ...
        // Actualizar scope con resultados (Dk)
        $scope.resultados = {
            ...$scope.resultados,
            ...resultadosCalculos,
        ...
        // Crear gráficas después de que se actualice el DOM (Dk)
        setTimeout(() => {
            $scope.crearGraficas();
    ...
    $scope.realizarCalculos = function (consumo, datos) {
        // Obtener producción por fuente (en TWh, convertir a kWh) (Dk)
        ...
        // Factor de estimación basado en el tipo de país (Dk)
